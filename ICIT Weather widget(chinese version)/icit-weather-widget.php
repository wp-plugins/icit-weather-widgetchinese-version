<?php
/*
 Plugin Name: ICIT天气插件汉化版
 Plugin URI: http://interconnectit.com/1474/wordpress-weather-widget/
 Description: 本天气插件给你提供了一种简单的天气预报显示方式，可以调试风格以和你的主题搭配并且没有任何使用限制。本插件由Ferris@Weiku汉化。
 Version: 1.0.0
 Author: Interconnect IT, James R Whitehead, Robert O'Rourke
 Author URI: http://interconnectit.com
 Translator URL: http://www.weiku.com
*/
		...
		*/
		...
		function widget( $args, $instance  ) {
			...
			if ( ! empty( $data ) ) {
				...
				if ( $credit )
					echo '<p class="icit-credit-link">'. __('Weather Widget by <a href="http://interconnectit.com/" title="Wordpress Development Specialists" target="_blank">Interconnect/IT</a>', ICIT_WEATHER_DOM) .'<br />'. __('Translated by <a href="http://www.weiku.com/" target="_blank">Weiku</a>', ICIT_WEATHER_DOM) .'</p>';
